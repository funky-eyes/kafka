...
class RingSharedWalTest {
    ...
    void reportsSuccessfulDurabilityBatchStats() throws Exception {
        ...
        try (RingSharedWal wal = new RingSharedWal(path, totalCapacity)) {
            ...
            assertTrue(first.durabilityDataForceNanos() >= 0L);
            assertTrue(first.durabilityCheckpointForceNanos() >= 0L);
            assertTrue(
            ...
            assertEquals(0L, first.singletonCoalesceWaitNanos());
            ...
            assertTrue(second.durabilityDataForceNanos() >= first.durabilityDataForceNanos());
            assertTrue(
                second.durabilityCheckpointForceNanos() >= first.durabilityCheckpointForceNanos()
            );
            assertTrue(
            ...
            assertEquals(0L, second.singletonCoalesceWaitNanos());
